      ...
      <div className="mx-auto w-full max-w-5xl space-y-6">
        <header className="theme-surface rounded-[28px] border p-6 backdrop-blur">
          ...
          <div className="mt-3 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h1 className="theme-text-primary text-4xl font-semibold tracking-tight">Sources</h1>
        ...
        <section className="theme-surface rounded-[28px] border p-6 backdrop-blur">
          <p className="theme-text-secondary text-sm">
            Nothing here yet. The button and route exist so this has somewhere to live once we decide
            what it should do.
          </p>
        </section>
      </div>
